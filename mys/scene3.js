class Scene3 extends Phaser.Scene {
    ...
    constructor ()
    {
        ...
        this.board = [
            {image:'1',sprite:'sprite1Animals'},
            {image:'2',sprite:'sprite2Animals'},
            {image:'3',sprite:'sprite3Animals'},
            {image:'4',sprite:'sprite4Animals'},
            {image:'5',sprite:'sprite5Animals'},
            {image:'6',sprite:'sprite6Animals'},
            {image:'7',sprite:'sprite7Animals'},
            {image:'8',sprite:'sprite8Animals'},
            {image:'9',sprite:'black'},
            {image:'10',sprite:'sprite10Animals'},
            {image:'11',sprite:'sprite11Animals'},
            {image:'12',sprite:'sprite12Animals'}
        ];    
    }
    ...
    preload ()
    {
        ...
        this.load.image('animal', 'mys/assets/animal.jpg');

        this.load.spritesheet('sprite1Animals', 'mys/assets/1-animals.jpg',
        { frameWidth: 200, frameHeight: 200 }  );
        
        this.load.spritesheet('sprite2Animals', 'mys/assets/2-animals.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
         
        this.load.spritesheet('sprite3Animals', 'mys/assets/3-animals.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
      
        this.load.spritesheet('sprite4Animals', 'mys/assets/4-animals.jpg',
        { frameWidth: 200, frameHeight: 200 }   );

        this.load.spritesheet('sprite5Animals', 'mys/assets/5-animals.jpg',
        { frameWidth: 200, frameHeight: 200 }  );
        
        this.load.spritesheet('sprite6Animals', 'mys/assets/6-animals.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
         
        this.load.spritesheet('sprite7Animals', 'mys/assets/7-animals.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
      
        this.load.spritesheet('sprite8Animals', 'mys/assets/8-animals.jpg',
        { frameWidth: 200, frameHeight: 200 }   );

        this.load.spritesheet('black', 'mys/assets/black.png',
        { frameWidth: 200, frameHeight: 200 }  );
        
        this.load.spritesheet('sprite10Animals', 'mys/assets/10-animals.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
         
        this.load.spritesheet('sprite11Animals', 'mys/assets/11-animals.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
      
        this.load.spritesheet('sprite12Animals', 'mys/assets/12-animals.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
    ...
    create ()
    {
        ...
        this.myimage =  this.add.image(this.x, this.y+450,'animal');
    ...
    putFinalPosition(image){
        if(image == 'sprite1Animals'){
            return new Position(-300,0);
        }else if(image == 'sprite2Animals'){
            return new Position(-100,0);
        }else if(image == 'sprite3Animals'){
            return new Position(100,0)
        }else if(image == 'sprite4Animals'){
            return new Position(300,0)
        }else if(image == 'sprite5Animals'){
            return new Position(-300,-200)
        }else if(image == 'sprite6Animals'){
            return new Position(-100,-200)
        }else if(image == 'sprite7Animals'){
            return new Position(100,-200)
        }else if(image == 'sprite8Animals'){
            return new Position(300,-200)
        }else if(image == 'black'){
            return new Position(-300,200)
        }else if(image == 'sprite10Animals'){
            return new Position(-100,200)
        }else if(image == 'sprite11Animals'){
            return new Position(100,200)
        }else{
            return new Position(300,200)
        }    
    ...
    hidePuzzle(){
        ...
        { fontFamily: 'myFont', fontSize:30, fill: '#ffff00'}, () => this.scene.start('Scene1'),finishTracking(window.location.href, 'Puzzle 2', 6,0));
