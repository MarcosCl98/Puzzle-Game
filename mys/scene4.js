class Scene4 extends Phaser.Scene {
    ...
    constructor ()
    {
        ...
        var blackpiece;
        this.board = [
            {image:'1',sprite:'sprite1Burguer'},
            {image:'2',sprite:'sprite2Burguer'},
            {image:'3',sprite:'sprite3Burguer'},
            {image:'4',sprite:'sprite4Burguer'},
            {image:'5',sprite:'sprite5Burguer'},
            {image:'6',sprite:'sprite6Burguer'},
            {image:'7',sprite:'sprite7Burguer'},
            {image:'8',sprite:'sprite8Burguer'},
            {image:'9',sprite:'black'},
            {image:'10',sprite:'sprite10Burguer'},
            {image:'11',sprite:'sprite11Burguer'},
            {image:'12',sprite:'sprite12Burguer'}
        ];    
    ...
    preload ()
    {
        ...
        this.load.image('burguer', 'mys/assets/burguer.png');

        this.load.spritesheet('sprite1Burguer', 'mys/assets/1-burguer.jpg',
        { frameWidth: 200, frameHeight: 200 }  );
        
        this.load.spritesheet('sprite2Burguer', 'mys/assets/2-burguer.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
         
        this.load.spritesheet('sprite3Burguer', 'mys/assets/3-burguer.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
      
        this.load.spritesheet('sprite4Burguer', 'mys/assets/4-burguer.jpg',
        { frameWidth: 200, frameHeight: 200 }   );

        this.load.spritesheet('sprite5Burguer', 'mys/assets/5-burguer.jpg',
        { frameWidth: 200, frameHeight: 200 }  );
        
        this.load.spritesheet('sprite6Burguer', 'mys/assets/6-burguer.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
         
        this.load.spritesheet('sprite7Burguer', 'mys/assets/7-burguer.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
      
        this.load.spritesheet('sprite8Burguer', 'mys/assets/8-burguer.jpg',
        { frameWidth: 200, frameHeight: 200 }   );

        this.load.spritesheet('black', 'mys/assets/black.png',
        { frameWidth: 200, frameHeight: 200 }  );
        
        this.load.spritesheet('sprite10Burguer', 'mys/assets/10-burguer.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
         
        this.load.spritesheet('sprite11Burguer', 'mys/assets/11-burguer.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
      
        this.load.spritesheet('sprite12Burguer', 'mys/assets/12-burguer.jpg',
        { frameWidth: 200, frameHeight: 200 }   );
    ...
    create ()
    {
        ...
        this.myimage = this.add.image(this.x, this.y+450,'burguer');
    ...
    putFinalPosition(image){
        if(image == 'sprite1Burguer'){
            return new Position(-300,0);
        }else if(image == 'sprite2Burguer'){
            return new Position(-100,0);
        }else if(image == 'sprite3Burguer'){
            return new Position(100,0)
        }else if(image == 'sprite4Burguer'){
            return new Position(300,0)
        }else if(image == 'sprite5Burguer'){
            return new Position(-300,-200)
        }else if(image == 'sprite6Burguer'){
            return new Position(-100,-200)
        }else if(image == 'sprite7Burguer'){
            return new Position(100,-200)
        }else if(image == 'sprite8Burguer'){
            return new Position(300,-200)
        }else if(image == 'black'){
            return new Position(-300,200)
        }else if(image == 'sprite10Burguer'){
            return new Position(-100,200)
        }else if(image == 'sprite11Burguer'){
            return new Position(100,200)
        }else{
            return new Position(300,200)
        }
    ...
    hidePuzzle(){
        ...
        { fontFamily: 'myFont', fontSize:30, fill: '#ffff00'}, () => this.scene.start('Scene1'),finishTracking(window.location.href, 'Puzzle 3', 6,0));
